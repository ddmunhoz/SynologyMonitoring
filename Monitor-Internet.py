...
def main():
    ...
    parser = argparse.ArgumentParser(description="A tool to send statistics to InfluxDB")
    parser.add_argument('--config', default='config_internet.ini', dest='config', help='Specify a custom location for the config file')
